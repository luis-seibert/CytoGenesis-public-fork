"""Assets module for font assets used in the game.

This module defines a FontAssets class that loads and manages font assets for the game.
The class includes methods for loading fonts dynamically based on the screen size and provides
access to various font sizes for different game elements.
"""
...
class FontAssets:
    ...
    def _load_fonts(self, base_font_size: float, pixel_font_path: str) -> None:
        ...
        self.medium_small_font = pygame.font.Font(pixel_font_path, round(base_font_size))
